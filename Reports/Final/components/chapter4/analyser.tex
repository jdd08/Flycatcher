...
% using proxies as parameters (trick to call constructor with them) -> builds objects that can be traversed to build up info => this method is highly flexible which is necessary given the highly flexible nature of javascript

% explain what information we store and why, giving the layout of the object
% why we have a central object