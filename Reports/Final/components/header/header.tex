...
\lstset{ %
  ...
  morekeywords={*,new,var,return,function,if,else,false,true,...},               % if you want to add more keywords to the set
  framexbottommargin=40pt
}
